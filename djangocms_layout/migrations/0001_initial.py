# -*- coding: utf-8 -*-
# Generated by Django 1.11.10 on 2018-03-05 11:59
...
import djangocms_layout.models
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='Section',
            fields=[
                ('cmsplugin_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, related_name='djangocms_layout_section', serialize=False, to='cms.CMSPlugin')),
                ...
                ('container', models.CharField(blank=True, choices=[('', 'No container (full-width)'), ('container', '.container (smaller content width based on device size)'), ('container-fluid', '.container-fluid (full-width with slight padding on sides)')], default='container', help_text='Adds a ".container" or ".container-fluid" element inside the section.Use it to have a full-page-width styled <section> with an inner container witha constrained width. All child plugins render inside the container.', max_length=25, verbose_name='Add nested .container or .container-fluid child element')),
                ('classes', djangocms_layout.models.Classes(blank=True, default='', help_text='Space separated classes that are added to the class. See <a href="http://getbootstrap.com/css/" target="_blank">Bootstrap 3 documentation</a>.', verbose_name='Classes')),
